  ...
  return (
    <div className="bg-[#fff8f0] text-black min-h-screen px-6 py-12">
      <div className="max-w-5xl mx-auto">
        <h1 className="text-4xl font-bold text-center text-orange-600 mb-6">More About Our Cakes</h1>
        ...
        <div className="text-center mt-10">
          <a
            href="/contact"
            className="bg-orange-500 text-white py-3 px-8 rounded-lg border-2 border-orange-600 hover:bg-transparent hover:text-orange-600 transition duration-300"
          >
            Contact Us ➜
          </a>
        </div>

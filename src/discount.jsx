...
function Discount() {
  return (
    <div className="relative bg-[#0a0a0acc] min-h-[500px] mt-12 px-4 py-10">
      <div className="flex flex-col md:flex-row md:justify-evenly gap-10 md:gap-4 items-center">
        ...
        <div className="relative h-[300px] w-full md:w-[400px]">
          <div className="absolute bottom-[100px] bg-amber-500 h-full w-full">
            <div className="border border-white absolute h-[270px] w-[90%] top-4 left-[5%] p-2 flex flex-col justify-center items-center text-center">
              <h1
      ...
      <div className="text-center mt-10">
        ...
        <Link to="/order">
          <button className="h-[45px] w-[130px] md:h-[50px] md:w-[140px] text-[16px] md:text-[19px] text-white bg-orange-500 items-center hover:bg-transparent border-2 border-amber-700 transition">
            Order Now
          </button>
        </Link>
      </div>

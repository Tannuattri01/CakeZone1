        ...
        <div className="flex flex-wrap justify-center mt-10 gap-6">
          ...
          <div className="relative w-full sm:w-[45%] md:w-[30%] lg:w-[30%]">
            ...
            <div className="bg-black h-30 relative">
              <div className="border border-white py-4 px-4 mx-4 absolute top-3 w-[90%] sm:w-[80%] lg:w-[90%] right-1 text-center text-white text-lg sm:text-2xl">
                <h1>Chef 1</h1>
                <h1>Designation</h1>
              </div>
            </div>
        ...
        <div className="max-w-7xl mx-auto grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-10">
          ...
          <div>
            ...
            <p className="mt-4 text-sm">
              Taste the best cakes in town with love and passion. Baked fresh
              daily!
            </p>
          </div>

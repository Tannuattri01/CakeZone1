    ...
    <div className="cakezone-section">
      ...
      {location.pathname === '/' && (
        <div className="relative">
          ...
          <img
            className="h-[600px] md:h-[855px] object-cover w-full"
            src="/images/background.jpg"
            alt="background"
          />
          <div className="absolute top-1/5 left-6 md:left-32 text-white">
            <h1
              className="text-[28px] md:text-[48px] text-orange-500"
            ...
            <h1
              className="text-[20px] md:text-[30px] mb-4"
              style={{ fontFamily: "'Pacifico', cursive" }}
            >
              The Best Cake In London
            </h1>
            <Link to="/read">
              <button className="h-[45px] w-[130px] md:h-[50px] md:w-[140px] text-[16px] md:text-[19px] bg-orange-500 hover:bg-transparent border-2 border-amber-700 transition">
                Read More
              </button>
            </Link>
          </div>
